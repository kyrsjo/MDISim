...
string DegMinSec(double Angle); // convert degrees in deg,min,sec, example DegMinSec(50.51) results in string 50¼30«36"
string LongDegMinSec(double Angle); // LongDegMinSec( 50.51) results in  50¼30«36" East
string LatiDegMinSec(double Angle); // LatiDegMinSec( 50.51) results in  50¼30«36" North

string DegMin(double Angle);    // convert degrees in deg,min,     example DegMinSec(50.51) results in string 50¼30.6«
string LongDegMin(double Angle); // LongDegMin( 50.51) results in  50¼30.6« East
string LatiDegMin(double Angle); // LatiDegMin( 50.51) results in  50¼30.6«North
